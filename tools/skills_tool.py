...
SKILL_VIEW_SCHEMA = {
    ...
    "description": (
        ...
        "its linked files (references, templates, scripts). Instructional skill "
        "content is complete and not paginated: context safety comes from output "
        "persistence and context compression, not lazy skill reading. First call "
        "returns SKILL.md content plus a 'linked_files' dict showing available "
