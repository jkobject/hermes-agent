...
KANBAN_GUIDANCE = (
    ...
    "task). It returns bounded latest slices of task/history data with truncation "
    "metadata, omitted counts, attachments, parent handoffs, and runs. Use "
    "`kanban_attachments` for all files or `hermes kanban context <task-id>` for "
    "canonical context.\n"
