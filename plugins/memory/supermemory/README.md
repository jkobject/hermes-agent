...
| `SUPERMEMORY_API_URL` | Legacy alias for `SUPERMEMORY_BASE_URL` |
...
Existing `api_url` entries in `supermemory.json` remain supported as a legacy
alias, after the preferred `base_url` key.
